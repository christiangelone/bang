...
if [[ "$PATH" != *"$BANG_PATH"* ]]; then
  ...
  *)
  ...
  echo "✏️  Adding bang to your PATH in $SHELL_PROFILE"
  echo "    \033[0;34m•\033[0m Please run \033[1;33msource $SHELL_PROFILE\033[0m"
